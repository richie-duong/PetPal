...
> Originally developed as a final project for the CST8318 Graphics Technologies course at Algonquin College, this project focused on the complete UI/UX design process, including low-fidelity wireframes, design systems, high-fidelity prototypes, usability testing, and final prototyping in Figma.

Following the completion of the course project, my partner Richard and Andrew decided to continue developing PetPal independently as a collaborative full-stack web application project, expanding the original design concept into a fully functional platform.
...
- Applying branding and visual styles
...
- Bootstrap
- Git & GitHub
- ZenHub (Agile sprint/task management)
...
- CRUD functionality for pet management
